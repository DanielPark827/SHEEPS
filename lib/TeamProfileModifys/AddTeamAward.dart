...
import 'package:sheeps_app/TeamProfileModifys/UploadForTeamAward.dart';
...
class AddTeamAward extends StatefulWidget {
  @override
  _AddTeamAwardState createState() => _AddTeamAwardState();
}

class _AddTeamAwardState extends State<AddTeamAward> {
                ...
                TextField(
                  ...
                  onChanged: (text) {
                    if(!Validation_NoSpecialChar(text, "대회명")) {
                      ...
                      CheckForAddAward_TeamModify(_ModifiedTeamProfile);
                    }
                  },
                ),
                ...
                GestureDetector(
                    onTap: (){
                      Navigator.push(
                          ...
                          MaterialPageRoute(
                              builder: (context) =>
                                  UploadForTeamAward()) // SecondRoute를 생성하여 적재
                      ).then((value) {
                        CheckForAddAward_TeamModify(_ModifiedTeamProfile);
                      });
                    },
  ...
  void CheckForAddAward_TeamModify(ModelTeamProfile _ModifiedTeamProfile) {
    if(_ModifiedTeamProfile.TeamAwardName != null && _ModifiedTeamProfile.TeamAwardGrade != null && _ModifiedTeamProfile.TeamAwardAgency != null && _ModifiedTeamProfile.TeamAwardTime != null && _ModifiedTeamProfile.IfAddTeamAwardUploadComplte == true &&
        _ModifiedTeamProfile.TeamAwardName != "" && _ModifiedTeamProfile.TeamAwardGrade != "" && _ModifiedTeamProfile.TeamAwardAgency != "" && _ModifiedTeamProfile.TeamAwardTime != "") {
