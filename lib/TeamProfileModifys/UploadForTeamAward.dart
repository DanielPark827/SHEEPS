...
import 'package:sheeps_app/TeamProfileModifys/UploadCompleteForTeamAward.dart';
...
class UploadForTeamAward extends StatefulWidget {

  @override
  _UploadForIdentifiedState createState() => _UploadForIdentifiedState();
}

class _UploadForIdentifiedState extends State<UploadForTeamAward> {
  File dummyFile;
        ...
        body: UploadBody(
          ...
          cameraFunc: () async {
            ...
            Navigator.push(
                ...
                MaterialPageRoute(
                    builder: (context) =>
                        UploadCompleteForTeamAward()) // SecondRoute를 생성하여 적재
            ).then((value) {
              Navigator.pop(context);
              Navigator.pop(context);
            });
