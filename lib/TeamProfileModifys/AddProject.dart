...
import 'package:sheeps_app/TeamProfileModifys/UploadForTeamProject.dart';
...
class _AddProjectState extends State<AddProject> {
                ...
                TextField(
                  ...
                  onChanged: (text) {
                    if(!Validation_NoSpecialChar(text, "프로젝트명")) {
                      ...
                      CheckForAddProject_TeamModify(_ModifiedTeamProfile);
                    }
                  },
                ),
                SizedBox(height: 16*sizeUnit),
                      ...
                      child: Container(
                        ...
                        child: Align(
                          ...
                          child: Padding(
                            ...
                            child: Text(
                              '${_ModifiedTeamProfile.ProjectStart == null ? '취득년월':_ModifiedTeamProfile.ProjectStart}',
                      ...
                      child: Container(
                        ...
                        child: Align(
                          ...
                          child: Padding(
                            padding: EdgeInsets.only(left: 12*sizeUnit),
                            child: Text(
                              '${_ModifiedTeamProfile.ProjectEnd == null ? '만료년월':_ModifiedTeamProfile.ProjectEnd}',
                ...
                GestureDetector(
                    onTap: (){
                      Navigator.push(
                          ...
                          MaterialPageRoute(
                              builder: (context) =>
                                  UploadForTeamProject()) // SecondRoute를 생성하여 적재
                      ).then((value) {
                        CheckForAddProject_TeamModify(_ModifiedTeamProfile);
                      });
                    },
  ...
  void CheckForAddProject_TeamModify(ModelTeamProfile _ModifiedTeamProfile) {
    if(_ModifiedTeamProfile.ProjectName != null && _ModifiedTeamProfile.ProjectAgency != null && _ModifiedTeamProfile.ProjectStart != null && _ModifiedTeamProfile.ProjectEnd != null && _ModifiedTeamProfile.IfAddProjectUploadComplete == true &&
        _ModifiedTeamProfile.ProjectName != "" && _ModifiedTeamProfile.ProjectAgency != "" && _ModifiedTeamProfile.ProjectStart != "" && _ModifiedTeamProfile.ProjectEnd != "") {
