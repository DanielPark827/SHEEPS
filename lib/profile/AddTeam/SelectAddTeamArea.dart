...
class SelectAddTeamArea extends StatefulWidget {
  SelectAddTeamArea({Key key, this.title}) : super(key: key);
  final String title;
...
class _SelectTeamAreaState extends State<SelectAddTeamArea> {
