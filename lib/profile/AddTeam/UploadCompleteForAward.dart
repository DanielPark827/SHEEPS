...
class UploadCompleteForAward extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    ...
    return MediaQuery(
      ...
      child: Scaffold(
        ...
        body: UploadCompleteBody(context, file: _ModifiedTeamProfile.AwardFile[_ModifiedTeamProfile.AwardFile.length-1]),
        // Column(
        //   children: [
        ...
        //                 image: FileImage(_ModifiedTeamProfile.AwardFile[_ModifiedTeamProfile.AwardFile.length-1]),
        //                 fit: BoxFit.cover)),
        //       ),
        //     ),
