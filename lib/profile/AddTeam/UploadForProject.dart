...
import 'package:sheeps_app/profile/AddTeam/UploadCompleteForProject.dart';
import 'package:sheeps_app/profile/models/ModelAddTeam.dart';
import 'package:sheeps_app/config/GlobalWidget.dart';
import 'package:sheeps_app/config/UploadUI.dart';

class UploadForProject extends StatefulWidget {

  @override
  _UploadForIdentifiedState createState() => _UploadForIdentifiedState();
}

class _UploadForIdentifiedState extends State<UploadForProject> {
  @override
        ...
        body: UploadBody(
          ...
          cameraFunc: () async {
            ...
            Navigator.push(
                ...
                MaterialPageRoute(
                    builder: (context) =>
                        UploadCompleteForProject()) // SecondRoute를 생성하여 적재
            ).then((value) {
              Navigator.pop(context);
              Navigator.pop(context);
            });
